shared.LoaderTitle = "Loading Scripts Pls Times";
...
local v119 = v16.ITM:AddToggle("ToggleAutoSea2", {
    Title = "Quest Sea 2",
    Description = "",
    Default = false
});
...
local v120 = v16.ITM:AddToggle("ToggleAutoSea3", {
    Title = "Quest Sea 3",
    Description = "",
    Default = false
});
...
local v56 = v16.Race:AddSection("Farm Race");
...
local v56 = v16.Shop:AddSection("Shop-Haki");
v16.Shop:AddButton({
    Title = "Geppo",
    Description = "",
    Callback = function()
...
local v56 = v16.Misc:AddSection("Join");
...
local v166 = v16.Sea:AddParagraph({
    Title = "Train Draco V4 (Soon)",
    Content = ""
});
local v167 = v16.Sea:AddToggle("ToggleTrialTeleport", {
    Title = "Tween Door Trial Race Draco",
    Description = "",
    Default = false
});
